<template>
    <q-card class="q-pa-md">
        <div class="flex justify-between items-center">
            <div class="text-lg text-weight-medium">Edit District</div>
        ...
        <q-form @submit="handleSubmit" class="column q-gutter-sm">
            ...
            <div class="flex justify-end items-center q-gutter-sm">
                ...
                <q-btn class="sized-btn" :loading="state.submitting" type="submit" color="primary" label="Update"/>
            </div>
        </q-form>
    </q-card>
</template>
...
const handleSubmit=e=>{
    form.put(route('district.update',props.district.id),{
        preserveState:false,
